...
int main()
{
    ...
    //Programming the memory for calculating first 10 Fibonacci numbers

    Program_Memory(0, "0000000100000110010000100001000011001000");
    Program_Memory(1, "0000000100000110010100100001000011001001");
    Program_Memory(2, "0000000100000110011000001111000000000100");
    Program_Memory(3, "0000000000000000000011111111000000000000");
    Program_Memory(4, "0000100100000110010100000001000001100100");
    Program_Memory(5, "0000010100000110010100100001000011001010");
    Program_Memory(6, "0010000100000110010100001010000000000000");
    Program_Memory(7, "0010000100000110010000000001000001100110");
    Program_Memory(8, "0000011000000110011100100001000001100110");
    Program_Memory(9, "0000000100000110100000000101000001100111");
    Program_Memory(10, "0010000100000110100000010011000000000101");
    Program_Memory(11, "0000000000000000000000001101000000000010");

    Program_Memory(100, "0000000000000000000000000000000000000000");
    Program_Memory(101, "0000000000000000000000000000000000000001");
    Program_Memory(102, "0000000000000000000000000000000000000111");
    Program_Memory(103, "0000000000000000000000000000000000000001");
    Program_Memory(104, "0000000000000000000000000000000011001010");

    Display_Memory_Start = 200;
    Display_Memory_End = 209;
